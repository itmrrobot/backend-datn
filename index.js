...
const brandRouter = require("./src/router/brand");
const orderRouter = require("./src/router/order");
const retunrsRouter = require("./src/router/returns");
...
const wishlistRouter = require("./src/router/wishlist");
const paypalRouter = require("./src/router/paypalPayment");
const inventoryRouter = require("./src/router/invertory");
const chatbotRouter = require("./src/router/chatbot");
const reviewsRouter = require("./src/router/reviews");
const orderDetailRouter = require("./src/router/orderDetail");
const recommendRouter = require("./src/router/recommend");
